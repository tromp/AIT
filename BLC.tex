...
\title{Functional Bits: basing Algorithmic Information Theory on Lambda Calculus}
\author{John Tromp}
...
languages.
Along the way we present a new graphical notation for lambda calculus,
a new representation of the empty list, improved bracket abstraction,
and a new fixpoint combinator.
In the second part
