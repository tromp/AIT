...
[[[0,n],[n,n]],n] = 1 + let p = [[n,[n,[n,n]]],n] in [[p,[p,[p,p]]],p] > 2^^^^2^2^p > 2^^^^2^^^^2^2^n
 ...
 [[0,[n,[[0,n],[n,n]]]],n] > 2^^^^^2^2^2^^^^^2^2^n > 2^^^^^2^^^^^2^2^n 

 [[1,[n,[[0,n],[n,n]]]],n] > 2^^^^^^2^3

 [[n,[n,[[0,n],[n,n]]]],n] > 2^^^^^^2^2^n

  [[0,n],[[0,n],[n,n]]] - 1 = let p = [n,[[0,n],[n,n]]] in [n,p] = [n,[n,[[0,n],[n,n]]]]
 [[[0,n],[[0,n],[n,n]]],n] = 1 + let p = [[n,[n,[[0,n],[n,n]]]],n] in [[p,[p,[[0,p],[p,p]]]],p] > 2^^^^^^2^2^p > 2^^^^^^2^2^2^^^^^^2^2^n > 2^^^^^^2^^^^^^2^2^n 

 [2+n,[n,n]] - 1 = let p = [[0,n],[n,n]] in [[0,n],p] = [[0,n],[[0,n],[n,n]]]
[[2+n,[n,n]],n] = 1 + let p = [[[0,n],[[0,n],[n,n]]],n] in [[[0,p],[[0,p],[p,p]]],p] > 2^^^^^^2^^^^^^2^2^p > 2^^^^^^2^^^^^^2^^^^^^2^^^^^^2^2^n

 [3+n,[n,n]] - 1 = [2+n,[2+n,[n,n]]]
[[3+n,[n,n]],n] = 1 + let p = [[2+n,[2+n,[n,n]]],n] in [[2+p,[2+p,[p,p]]],p] > 

  [2+n,[2+n,[n,n]]] - 1 = let p = [1+n,[2+n,[n,n]]] in [1+n,p] = [1+n,[1+n,[2+n,[n,n]]]]
 [[2+n,[2+n,[n,n]]],n] = 1 + let p = [[1+n,[1+n,[2+n,[n,n]]]],n] in [[1+p,[1+p,[2+p,[p,p]]]],p] > 
